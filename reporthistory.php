...
<table>
   ...
   <?php 
    ...
    $sql = mysqli_query($conn, "SELECT * FROM report_table");
    if(mysqli_num_rows($sql) > 0){
      while ($row = mysqli_fetch_assoc($sql)){
        echo "<tr><td>" . $row["Email Address"]. "</td><td>" . $row["First_Name"] . "</td><td>" . $row["Last_Name"] . "</td><td>" . $row["Report"] . "</td><td>" . $row["user_u_id"] . "</td></tr>";
      }
      echo "</table>";
    }
   ?>
